...
-- Terminal
local shell = vim.fn.executable("bash") == 1 and "bash" or ""   -- prefer bash terminal

vim.api.nvim_set_keymap("n", "T", ":cd %:h | vsplit | term "    -- split correctly
.. shell .. "<CR>", { noremap = true, silent = true })

vim.api.nvim_set_keymap("t", "<Esc>", [[<C-\><C-n><CR>]],       -- normal mode in terminal
